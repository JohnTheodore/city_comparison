...
from data_sources import FBI_CRIME_2014_CSV_FILENAME, FBI_CRIME_2015_CSV_FILENAME, FBI_CRIME_2016_CSV_FILENAME, FBI_CRIME_2017_CSV_FILENAME, EXPERIAN_FINAL_CSV_FILENAME
...
if __name__ == '__main__':
  ...
  combined_mean.to_csv('./combined_fbi_mean.csv', index=True)
